...
export const PARAMETERS: Parameter[] = [
  ...
  { key: 'firmEntryElasticity', label: 'Entry response to profit', min: 0, max: 8, step: 0.5 },
  { key: 'firmMarginMemory', label: 'How fast the remembered margin resets', min: 0.002, max: 0.2, step: 0.01 },
