...
export const PARAMETERS: Parameter[] = [
  ...
  { key: 'firmExitRate', label: 'Firms failing per year', min: 0, max: 0.04, step: 0.003 },
  { key: 'firmExitCyclicality', label: 'Failures response to the cycle', min: 0, max: 8, step: 0.5 },
  { key: 'firmEntryElasticity', label: 'Entry response to trade per firm', min: 0, max: 8, step: 0.5 },
  { key: 'firmTradeMemory', label: 'How fast the remembered trade level resets', min: 0.002, max: 0.2, step: 0.01 },
  ...
  { key: 'personAbilitySpread', label: 'Spread of how good people are', min: 0, max: 0.5, step: 0.04 },
